  ...
  if (typeof result !== 'undefined') {
    for (var i = 0; i < result.length; i++) {
      ...
      if (typeof result[i] !== 'undefined') {
        console.log("first")
        if (typeof result[i].entities !== 'undefined') {
          console.log('yaya')
          if (typeof result[i].entities.type !== 'undefined' && result[i].entities.type == 'photo') {
            console.log("COOOL")
            setTimeout(10000)
